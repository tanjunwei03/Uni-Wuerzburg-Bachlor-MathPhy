...
\end{Theorem}
\begin{proof}
	There is a compact neighbourhood $V$ of $0$ in $ V$ such that $K+V\cap C=\varnothing$ (Corollary \ref{cor:compacttranslates}). Then, we apply Theorem \ref{thm:sep1} to $K+V$ and $C$ to get a linear functional that satisfies all the required properties, since $K$ is a compact subset of $K+V$. 
\end{proof}
