...
Suppose $V$ and $W$ are topologicl vector spaces, and $\Gamma$ is a collection of linear maps $V\to W$. Let $B$ be the set of all $v\in V$ such that the orbits
\[
...
\begin{proof}
	...
	.\] 
	Since $B$ is nonmeager, we have at least one $nE$ nonmeager.
\end{proof}
\section{idk}
\begin{Theorem}
