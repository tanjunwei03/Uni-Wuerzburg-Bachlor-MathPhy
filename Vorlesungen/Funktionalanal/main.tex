...
\begin{Theorem}[Sequential Compactness of Unit Ball]
	Let $V$ be a separable Banach space. Then $B_1(0)^\text{cl}\subseteq V'$ is first countable in the weak *-topology.
\end{Theorem}
\begin{proof}
	First, we begin by letting $\{v_1, \dots,\} $ be a countable dense subset of $V$. 
\end{proof}
This implies that it is sequentially compact by the next theorem:
\begin{Theorem}
