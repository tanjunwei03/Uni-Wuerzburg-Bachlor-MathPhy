...
.\] 
It is obvious that $T$ has all real and nonegative entries. It is also obvious that all rows and columns sum up to 1. 

Finally, we can compute the product
\[
	T\vec{\lambda} = \frac{1}{2}\begin{pmatrix}1 & 1 \\ 1 & 1  \end{pmatrix} \begin{pmatrix} (2+\sqrt{2}) / 4 \\ (2 - \sqrt{2} ) / 4   \end{pmatrix} = \begin{pmatrix} 1 / 2 \\ 1 / 2 \end{pmatrix} =\vec{p} 
.\qedhere\] 
	\end{parts}
\end{proof}
