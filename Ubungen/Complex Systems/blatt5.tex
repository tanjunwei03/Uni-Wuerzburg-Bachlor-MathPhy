...
\begin{proof}
	...
	\item We compute
		...
		\end{align*}
		where we have used Theorem \ref{thm:complexsystemsblatt5-1} to show that $\mathbf{A}\otimes\mathbbm{1}$ and $\mathbbm{1}\otimes \mathbf{B}$ commute.
	\item The eigenvalues and eigenvectors of $A\otimes B$ are given by $\ket{a}\otimes \ket{b}$. We can see this by definition:
		\[
