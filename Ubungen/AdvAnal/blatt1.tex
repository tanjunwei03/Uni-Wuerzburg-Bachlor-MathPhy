...
\begin{proof}
	...
	\item 
		...
		.\]\marginnote{\[f^{-1}\left( \bigcap_{\mathcal A\in P} \mathcal A \right) =\bigcap_{\mathcal A\in P} f^{-1}(\mathcal A)\] stimmt nicht. Es gilt zu sagen, weil $\mathcal{M}\subseteq \mathcal{A}_\sigma(\mathcal{M})$, gilt auch 		\begin{align*}
				f^{-1}(\mathcal{M})\subseteq& f^{-1}\left(\mathcal{A}_\sigma\left(\mathcal{M}\right)\right)\\
				\mathcal{A}_\sigma(f^{-1}(\mathcal{M}))\subseteq& \mathcal{A}_\sigma\left(f^{-1}\left(\mathcal{A}_\sigma\left(\mathcal{M}\right)\right)\right)=f^{-1}\left(\mathcal{A}_\sigma\left(\mathcal{M}\right)\right)
		\end{align*}}
