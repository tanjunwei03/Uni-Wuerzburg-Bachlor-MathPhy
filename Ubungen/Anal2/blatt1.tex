...
\[
	...
	.\] 
	Deswegen gibt es \emph{keine} globales Maximum auf $\R$. Wenn man $f(\infty)$ definiert durch $f(\infty)=\lim_{x \to \infty} f(x)$, ist $f(\infty)$ das globale Maximum.\marginnote{Tipfehler - Maximum sollte Minimum sein.}
